...
Ask questions via [https://createmod.com/contact](https://createmod.com/contact). GitHub issues are not the appropriate place to debug your specific project, but should be reserved for filing bugs and feature requests.
...
Please reach out to use privately regarding security issues via [https://createmod.com/contact](https://createmod.com/contact). **Do not** file a public issue for security vulnerabilities.
